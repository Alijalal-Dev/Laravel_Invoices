...
class InvoicesController extends Controller
{
    ...
    {
        //edit invoices li kyna fal 3amaliayt ftab invoices
        $invoices = invoices::where('id', $id)->first();
        $sections = sections::all();
    ...
    public function destroy(Request $request)
    {
        ...
        if (!$id_page == 2) {
            ...
            if (!empty($Details->invoice_number)) {
                ...
                Storage::disk('public_uploads')->deleteDirectory($Details->invoice_number); //la suppression file attachment
            }
            //$invoices->Delete(); //si en veut que les donnée restent dans BD (Softdelete)
    ...
    //affichage des cature payé/non payé/payer partielemeny
    ...
    public function searchPage(Request $request)
    {
        ...
        // Define an associative array of menu items and their corresponding routes
        $menuItems = [
        ...
        // Handle the case where no matching menu item is found
